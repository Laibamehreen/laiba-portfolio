      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-6 cv-card p-6 sm:p-8 flex flex-col justify-between h-full"
          >
            <div>
              ...
              <div className="mt-6 pt-6 border-t border-white/[0.06]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {PROFILE_DATA.coreStrengths.map((strength, sIdx) => (
                    <motion.div
                      key={strength}
                      initial={{ opacity: 0, y: 10 }}
                      whileInView={{ opacity: 1, y: 0 }}
                      viewport={{ once: true }}
                      transition={{ duration: 0.4, delay: 0.1 + sIdx * 0.05, ease: [0.16, 1, 0.3, 1] }}
            ...
            <div className="mt-6 pt-5 border-t border-white/[0.06] flex flex-wrap gap-2">
              {["Java", "Spring Boot", "Spring Data JPA", "Spring Security", "REST APIs", "React", "Next.js"].map((tech, tIdx) => (
                <motion.span
                  key={tech}
                  initial={{ opacity: 0, scale: 0.9 }}
                  whileInView={{ opacity: 1, scale: 1 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.35, delay: 0.15 + tIdx * 0.04, ease: [0.16, 1, 0.3, 1] }}
        ...
        {/* Education Portion Inside About Me */}
        <motion.div
          id="education"
          ...
          className="mt-8 cv-card p-6 sm:p-8 scroll-mt-24"
        >
          <div className="flex flex-wrap items-start justify-between gap-4 mb-4 pb-4 border-b border-white/[0.06]">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <span className="text-xs uppercase tracking-wider font-semibold text-lavender-400">
                  Academic Education
                </span>
